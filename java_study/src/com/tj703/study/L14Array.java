...
public class L14Array {
    public static void main(String[] args) {
        ...
        int [] nums={1,2,3,}; //( ,) : 자동으로 삭제
        //nums={1,2,3}; //리터럴 선업법은 꼭 변수를 선언하면서 대입 해야 합니다.
        //nums=new int[3];
        System.out.println(0);
        System.out.println(1);
        System.out.println(2);
        //js는 index 밖의 자료를 참조하면 undefined
        //java 오류 IndexOutOfBoundsExcption(index 가 Array 객체의 길이에서 벗어났다)
        ...
        //Array 길이가 변하지 않는다.(push,pop x : 배열의 길이를 변화시키는 함수)
        //js는 Array 가 존재하지 않고 java 의 ArrayList 와 유사한 객체가 만들어진다. 길이 변화가 가능하다.
        //java Array toString() 이 재정의 되어 있지 않아서 타입+메모리 주소가 출력
        System.out.println(numArr); //[I@b4c966a

        String [] strArr={"안녕","하세요!"};
        System.out.println(strArr); //[Ljava.lang.String;@2f4d3709
        Integer [] objIntArr={1,2,3,4}; //Integer :int 의 랩퍼 타입
        System.out.println(objIntArr); //[Ljava.lang.Integer;@4e50df2e
        // [ : Array
        // [L : 자료형을 참조하는 Array
        // [I : 기본형 int 참조하는 Array
        // [ I,Z,C..@주소 : 기본형 int 참조하는 Array
        boolean [] booleArr={true,false,true,false};
        boolean [] booleArr2={true,false,true,false};
        System.out.println(booleArr);
        System.out.println(booleArr2);
        char [] charArr={'안','녕','한','가'}; //"안녕"을 선언하면 {'안','녕'}이 생성된다.
        System.out.println(charArr); //문자열인척 출력 된다.
        ...
        //자료형끼리 동등 비교는 완전히 같지 않는 이상 무조건 false
        System.out.println(nums.equals(nums2)); //[].equals 가 재정의  되어 있지 않음
