...
public class L11InnerClass {
    User user=new User("재덕","watb",33);
    User user2=this.new User("재덕","watb",33);
    ...
    public static void main(String[] args) {
        ...
        //일반적이지도 않고 권장하지도 않는다.
        L11InnerClass.User inUser=innerClass.new User("둘리","hoihoi",41);
        L11InnerClass.User inUser2=new L11InnerClass().new User("고길동","help",35);
