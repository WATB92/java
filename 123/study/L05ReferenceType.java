...
public class L05ReferenceType {
    public static void main(String[] args) {
        ...
        //java.lang.Object@b4c966a => "안녕" (String Object.toString() 재정의 한다.) toString() 생략가능
        ...
        System.out.println(str.charAt(1)); //문자열은 배열이기 때문에 index를 참조할 수 있다.
        System.out.println(str.length());

        //js 자료형 데이터인데 리터럴 표기법을 지원하는 것 : {key:value},[1,2,3]

        //순서(index)와 길이가 존재하는 자료 : 배열
        int [] arr={1,2,3}; // 배열 자료형을 리터럴하게 표기
        ...
        Schedule s=new Schedule("스케줄객체");
        //js는 매개변수를 생략하면 undefined가 되지만
        //java는 매개변수를 생각할 수 없다. (강제)
